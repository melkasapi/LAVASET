...
class StochasticBosque:   
    ...
    def draw_graph_with_curved_edges(self, G, pos, node_colors, top_edges, high_nodes, low_nodes, final_pos, name, colormap, norm, vmin, vmax, n):
        ...
        # Add a title
        plt.title("Gradient Boost Feature Importance Assignment in " + name, fontsize=18, x=0.55)
        ...
        folder_path = "C:\\Users\\Eloisa\\Documents\\ICL\\3_Project_1\\Results\\Pub_results\\Final\\NetworkX\\Aggregated\\GBDT"
    ...
    def get_stat_annotations(self, df, pairs, p_values):
        annotations = []
        step = 0.1  # Step to place annotations above the plot

        for i, ((group1, group2), p_value) in enumerate(zip(pairs, p_values)):
            y = i 
